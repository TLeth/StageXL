...
class MouseEvent extends Event {
  ...
  MouseEvent(String type, bool bubbles, this.localX, this.localY, this.stageX, this.stageY, this.deltaX, this.deltaY, this.buttonDown, this.clickCount, this.altKey, this.ctrlKey, this.shiftKey) : super(type, bubbles);
