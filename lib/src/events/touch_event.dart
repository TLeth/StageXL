...
class TouchEvent extends Event {
  ...
  TouchEvent(String type, bool bubbles, this.touchPointID, this.isPrimaryTouchPoint, this.localX, this.localY, this.stageX, this.stageY, this.altKey, this.ctrlKey, this.shiftKey) : super(type, bubbles);
}
