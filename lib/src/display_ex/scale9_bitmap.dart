...
class Scale9Bitmap extends Bitmap {
  ...
  _updateRenderTextureQuads() {
    ...
    _renderTextureQuads = [renderTextureQuad.cut(new Rectangle<int>(x0, y0, x1 - x0, y1 - y0)), renderTextureQuad.cut(new Rectangle<int>(x1, y0, x2 - x1, y1 - y0)), renderTextureQuad.cut(new Rectangle<int>(x2, y0, x3 - x2, y1 - y0)), renderTextureQuad.cut(new Rectangle<int>(x0, y1, x1 - x0, y2 - y1)), renderTextureQuad.cut(new Rectangle<int>(x1, y1, x2 - x1, y2 - y1)), renderTextureQuad.cut(new Rectangle<int>(x2, y1, x3 - x2, y2 - y1)), renderTextureQuad.cut(new Rectangle<int>(x0, y2, x1 - x0, y3 - y2)), renderTextureQuad.cut(new Rectangle<int>(x1, y2, x2 - x1, y3 - y2)), renderTextureQuad.cut(new Rectangle<int>(x2, y2, x3 - x2, y3 - y2))];
  }
}
