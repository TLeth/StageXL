...
class RenderProgramMesh extends RenderProgram {
  ...
  void renderMesh(int indexCount, Int16List indexList, int vertexCount, Float32List xyList, Float32List uvList, num r, num g, num b, num a) {
